...
#요소 추가
# fruits.append("grape") #마지막에 요소 추가
# fruits.insert(1, "mango") #특정 인덱스 위치에 추가
# print(fruits)
...
# numbers2 = sorted(numbers) #원본 변수에는 영향 X, 새 변수에 값을 할당
...
numbers = (1, 3, 5, 7, 9)
mixed = ("pink", 1, True)
single_tuple = ("hello",) #요소가 1개일 때는 꼭 ,를 붙여야함
...
#index
print(alphabet.index("b")) #find는 문자열에서만 가능
